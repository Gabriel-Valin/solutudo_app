...
<head>
    ...
    <title>Editar Empresa - Solutudo</title>
</head>

<body>
    <h1 class="bodymember">Editar Empresa.</h1>
    <div class="center-all">

        <form action="<?php base_url() ?>editcompany/updateinfocompany/<?= $company_info[0]['id'] ?>" method="POST">
            ...
            <input class="form-member" type="email" name="email" value="<?php echo $company_info[0]['email'] ?>"></br></br>
            ...
            <input class="form-member" type="text" name="city" value="<?php echo $company_info[0]['cidade'] ?>"></br></br>

            <input class="entry" type="submit" value="EDIT COMPANY">
